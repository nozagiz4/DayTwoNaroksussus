...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="Content">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link"style="color: white;" href="index2.php">IMAGE</a>
                  </li>
   ...
   <div class="container-fluid" style="margin-top: 180px;">
         ...
         <div class="row" style=" background: #f0f0f0; width: 1290px; height:565px; margin: auto;">
             ...
             <div class="row">
                <div class="col-6">
                   <img id="1" src="1.jpg" alt="1" width="550px" height="392px" style="border-radius: 1.5%; float: left; margin-left: 10px;">
                </div>
         ...
         <div class="row" style="margin: auto;">
            <div class="related">
              <p style=" font-weight: bold; font-size: 26px; margin: auto;">RELATED PICTURES</p>
                <div class="row">
                    <div class="col-4">
                      <a href="Detail-image-id-4.php"><img  src="4.jpg" alt="4" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                       <a href="Detail-image-id-5.php"><img src="5.jpg" alt="5" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-6.php"><img src="6.jpg" alt="6" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                       <a href="Detail-image-id-7.php"><img src="7.png" alt="7" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                    <a href="Detail-image-id-8.php"><img src="8.jpg" alt="8" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-9.php"><img src="9.jpg" alt="9" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-10.php"><img src="10.jpg" alt="10" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-11.php"><img  src="11.png" alt="11" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-12.php"><img src="12.jpg" alt="12" width="100%" height="100%" style=" border-radius: 1.5%;"></a>  
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-13.php"><img src="13.jpg" alt="13" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-14.php"><img src="14.jpg" alt="14" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-15.php"><img src="15.png" alt="15" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>     
