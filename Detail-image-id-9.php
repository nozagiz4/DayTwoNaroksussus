...
<body>
   ...
   <div class="container-fluid" style="margin-top: 180px;">
         <div class="row" style=" background: #f0f0f0; width: 1290px; height:565px; margin: auto;">
             ...
             <div class="row">
                <div class="col-6">
                   <img id="9" src="9.jpg" alt="9" width="550px" height="392px" style="border-radius: 1.5%; float: left; margin-left: 10px;">
                </div>
            ...
            <div class="related">
              <p style=" font-weight: bold; font-size: 26px; margin: auto;">RELATED PICTURES</p>
                ...
                <div class="row" style="margin-top: 2%;">
                    ...
                    <div class="col-4">
                        <a href="Detail-image-id-3.php"><img src="3.jpg" alt="3" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                </div>
