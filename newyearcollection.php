...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-custom1">
            <div class="container-fluid">
              ...
              <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button style=" font-size: 20px; font-weight: bold;" class="btn btn-outline-light l_R_B"><a href="Login-1.php" style="color: white;text-decoration: none;">LOGIN</a> </button>
                    <button style="margin-left: 15px;font-size: 20px; font-weight: bold;" class="btn btn-light l_R_B"><a href="Register.php" style="color:  rgb(72, 109, 135);text-decoration: none;">REGISTER</a> </button>
                </form>
              </div>
            </div>
          </nav>
    ...
    <div class="container" style="margin-top: 180px;">
        <p style=" font-weight: bold; font-size: 28px;">NEWYEAR COLLECTION</p>
                <div class="row">
                    <div class="col-4" >
                        <a href="Detail-image-id-1.php"><img id="1" src="1.jpg" alt="1" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4" >
                        <a href="Detail-image-id-2.php"><img  id="2" src="2.jpg" alt="2" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-3.php"><img id="3" src="3.jpg" alt="3" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4" >
                        <a href="Detail-image-id-4.php"><img id="4" src="4.jpg" alt="4" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4" >
                       <a href="Detail-image-id-5.php"><img id="5" src="5.jpg" alt="5" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-6.php"><img id="6" src="6.jpg" alt="6" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                       <a href="Detail-image-id-7.php"><img id="7" src="7.png" alt="7" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-8.php"><img id="8" src="8.jpg" alt="8" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-9.php"><img id="9" src="9.jpg" alt="9" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4" >
                        <a href="Detail-image-id-10.php"><img id="10" src="10.jpg" alt="10" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-11.php"><img id="11" src="11.png" alt="11" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-12.php"><img id="12" src="12.jpg" alt="12" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-13.php"><img id="13" src="13.jpg" alt="13" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-14.php"><img id="14" src="14.jpg"14" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-15.php"><img id="15" src="15.png" alt="15" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                        <a href="Detail-image-id-16.php"><img id="16" src="16.jpg" alt="16" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                       <a href="Detail-image-id-17.php"><img id="17" src="17.jpeg" alt="17" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-18.php"><img id="18" src="18.jpg" alt="18" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>

                <div class="row" style="margin-top: 2%;">
                    <div class="col-4">
                     <a href="Detail-image-id-19.php"><img id="19" src="19.jpg" alt="19" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-20.php"><img id="20" src="20.jpg" alt="20" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                    <div class="col-4">
                        <a href="Detail-image-id-21.php"><img id="21" src="21.jpg" alt="21" width="100%" height="100%" style=" border-radius: 1.5%;"></a>
                    </div>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <ul class="list-unstyled" >
                <li style="margin-bottom: 10px;margin-top: 15px;"><a href="index2.php"style="color: white; text-decoration: none;">Image</a></li>
