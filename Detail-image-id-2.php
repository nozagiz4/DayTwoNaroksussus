...
<body>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="Content">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link"style="color: white;" href="index.php">IMAGE</a>
                  </li>
   ...
   <div class="container-fluid"style="margin-top: 180px;">
         <div class="row" style=" background: #f0f0f0; width: 1290px; height:565px; margin: auto;">
             ...
             <div class="row">
                <div class="col-6">
                   <img id="1" src="2.jpg" alt="2" width="550px" height="392px" style="border-radius: 1.5%; float: left; margin-left: 10px;">
                </div>
