         ...
         <div class="row" style="margin: auto;">
            <div class="related">
              <p style=" font-weight: bold; font-size: 26px; margin: auto;">RELATED PICTURES</p>
                <div class="row">
                    <div class="col-4">
                        <a href="Mirror-detail-image-id-4.php"><img  src="4.jpg" alt="4" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                    <div class="col-4">
                        <a href="Mirror-detail-image-id-5.php"><img src="5.jpg" alt="5" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                    <div class="col-4">
                        <a href="Mirror-detail-image-id-6.php"></a><img src="6.jpg" alt="6" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 2%;">
                    ...
                    <div class="col-4">
                        <a href="Mirror-detail-image-id-2.php"><img  src="2.jpg" alt="2" width="100%" height="100%" style=" border-radius: 1.5%;" ></a>
                    </div>
                    <div class="col-4">
